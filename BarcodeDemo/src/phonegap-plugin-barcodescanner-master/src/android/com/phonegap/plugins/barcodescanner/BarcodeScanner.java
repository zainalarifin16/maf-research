...
public class BarcodeScanner extends CordovaPlugin {
    // change this from the original value of 0x0ba7c0de to just 0x0000c0de
    // since the support fragment activities will validatew that only the lower
    // 16-bits of the int are used for the request code.
