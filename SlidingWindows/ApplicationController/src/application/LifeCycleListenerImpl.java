...
import application.SlidingDrawerBean;
...
public class LifeCycleListenerImpl implements LifeCycleListener
{
  ...
  
  {
      ...
      /*
      String slidingWindowDrawer = AdfmfSlidingWindowUtilities.create("SlidingDrawer");  //slidingWindowContent
      ...
      options.setSize("0");
*/
     // boolean b = AdfmfSlidingWindowUtilities.show(slidingWindowDrawer,options);
