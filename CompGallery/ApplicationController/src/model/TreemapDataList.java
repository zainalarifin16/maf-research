...
public class TreemapDataList {
    ...
    public TreemapDataList() {
        super();
    }
    
    public List<TreeviewData> getTreemapData() {
        return is2009 ? list2009 : list2010;
    }
    
    public void refreshTreemap(ValueChangeEvent valueChangeEvent) {
        String value = (String) valueChangeEvent.getNewValue();
        is2009 = value.equals("2010");
        
        ValueExpression ve = AdfmfJavaUtilities.getValueExpression("#{bindings.treemapDataIterator}", Object.class);
