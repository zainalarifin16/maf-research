 ...
 * time.  Since this plugin may be instantiated multiple times in the one app (if
 * the app has multiple WebViews), this method should be called within the context
 * of only one WebView.
 */
