...
public class EmployeeList {
    private static List<Employee> s_employees = null;
    ...
    public List<Employee> getEmployees() {
        System.out.println("Returning Employee list");
        return s_employees;
    }
    ...
    public Employees getEmps() {
        if (emps == null || emps.getEmps() == null) {
            emps = new Employees();
            emps.setEmps(s_employees);
        }
        System.out.println("Returning Employee list: " + emps.getEmps().size());
